            ...
            <div className="lg:col-span-7">
              ...
              <Reveal delay={80}>
                ...
                <div className="mt-8 flex items-center gap-5">
                  <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground transition-colors hover:text-accent">
                    <LinkedInIcon className="size-5" />
                  </a>
                  <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground transition-colors hover:text-accent">
                    <FacebookIcon className="size-5" />
                  </a>
                  <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground transition-colors hover:text-accent">
                    <InstagramIcon className="size-5" />
                  </a>
                  <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-muted-foreground transition-colors hover:text-accent">
                    <TikTokIcon className="size-5" />
                  </a>
                  <a href="https://www.github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground transition-colors hover:text-accent">
                    <GitHubIcon className="size-5" />
                  </a>
                  <a href="mailto:centeno.lorenzo.nicholas@gmail.com" aria-label="Gmail" className="text-muted-foreground transition-colors hover:text-accent">
              ...
              <Reveal delay={180}>
                <p className="mt-8 max-w-xl border-l-2 border-accent/30 pl-4 text-base leading-relaxed text-muted-foreground">
                  A UI/UX Designer crafting high-fidelity interfaces in Figma and leveraging advanced AI workflows to build and deploy production-ready digital products. I bridge the gap between pure design and rapid deployment.
                </p>
              </Reveal>
              <Reveal delay={260}>
                <div className="mt-10 flex flex-wrap gap-3">
                  ...
                  <Link
                    to="/services"
                    className="text-mono inline-flex h-11 items-center gap-2 rounded-md border hairline bg-transparent px-5 text-xs uppercase tracking-[0.2em] text-foreground transition-colors hover:border-accent/40"
                  >
                    Services <span className="transition-transform group-hover:translate-x-1">→</span>
                  </Link>
                </div>
              </Reveal>
            </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24">
          <Reveal>
            ...
            <p className="mt-4 max-w-lg text-sm text-muted-foreground">
              Three focused layers — visual architecture, AI orchestration, and edge delivery — producing production-grade software at unusual velocity.
            </p>
          </Reveal>
                  ...
                  <div className="flex flex-1 flex-col px-6 py-5">
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {svc.chips.map((chip) => (
                        ...
                        >
                          <ChipIcon name={chip.icon} className="size-3.5 text-accent" />
                          {chip.label}
                        </span>
                      ))}
                    </div>
        ...
        <div className="mb-6">
          <Reveal>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-display text-lg font-medium">{DESIGN_PROJECTS[0].title}</h3>
                <p className="mt-2 line-clamp-2 text-sm text-muted-foreground">{DESIGN_PROJECTS[0].summary}</p>
              </div>
            </Link>
          </Reveal>
        </div>
          ...
          {DESIGN_PROJECTS.slice(1).map((p, i) => (
            <Reveal key={p.slug} delay={i * 60}>
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-display text-lg font-medium">{p.title}</h3>
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
              <div className="md:col-span-5">
                ...
                <p className="mt-4 text-sm text-muted-foreground">
                  Outline the scope, the constraint, and the deadline. I respond within two business
                  days.
                </p>
                <Link
                  to="/contact"
          ...
          <div className="relative hidden h-[280px] lg:col-span-5 lg:block">
            <div className="absolute left-0 top-0 w-[200px] rounded-xl border border-white/10 bg-[oklch(0.13_0.009_240/0.9)] p-4 shadow-xl">
              ...
              <div className="space-y-2">
                {["CPU", "Hardware Block"].map((l) => (
                  <div key={l} className="flex items-center gap-2">
                    <div className="h-6 w-16 rounded bg-white/5 border border-white/10 flex items-center justify-center">
                      <span className="text-[8px] text-muted-foreground">{l}</span>
                    </div>
                    <div className="h-px w-6 bg-accent/40" />
                    <div className="h-6 w-16 rounded bg-white/5 border border-white/10 flex items-center justify-center">
                      <span className="text-[8px] text-muted-foreground">Module</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="absolute bottom-0 left-12 w-[220px] rounded-xl border border-white/10 bg-[oklch(0.13_0.009_240/0.9)] p-4 shadow-xl">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                {[1, 2, 3, 4].map((n) => (
                  <div key={n} className="h-10 rounded-md border border-white/10 bg-white/5 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
            ...
            <div className="md:col-span-7 md:col-start-6">
              <p className="text-lg leading-relaxed text-muted-foreground">
                Years of real-world management, team leadership, and logistics coordination inject
                strict engineering discipline, robust documentation, and absolute operational
                reliability into every digital product I build.
              </p>
              <Link
                to="/about"
        ...
        <div className="profile-flip-face profile-flip-back">
          ...
          <div className="flex flex-col items-center gap-5 px-8">
            ...
            <div className="mt-2 flex flex-col gap-3 w-full">
              <Link
                to="/contact"
                className="text-mono inline-flex h-11 w-full items-center justify-center rounded-md bg-accent px-6 text-xs uppercase tracking-[0.2em] text-background font-semibold transition-all duration-300 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_0_24px_rgba(0,255,255,0.4)]"
              >
                Hire Me
              </Link>
              <a
                href="/cv.pdf"
                download
                className="text-mono inline-flex h-11 w-full items-center justify-center rounded-md border border-accent/50 bg-transparent px-6 text-xs uppercase tracking-[0.2em] text-accent transition-all duration-300 hover:bg-accent/10 hover:-translate-y-0.5 hover:border-accent hover:shadow-[0_0_20px_rgba(0,255,255,0.2)]"
              >
                Download CV
              </a>
            </div>
